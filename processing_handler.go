...
func respondWithImageInfo(reqID string, r *http.Request, rw http.ResponseWriter, po *options.ProcessingOptions, originURL string, imageSize int) {
	rw.WriteHeader(200)
...
func handleProcessing(reqID string, rw http.ResponseWriter, r *http.Request) {
	...
	if po.IsImageInfoRequested() {
		respondWithImageInfo(reqID, r, rw, po, imageURL, len(originData.Data))
		return
	}
